...
config = config()
config.General.requestName = 'monotopTree_MT_1TeV_LH_13TeV_lep_V11'
...
config.Data.userInputFiles = open('mt_lep_1tev_LH.txt').readlines()
...
config.Data.outLFNDirBase = '/store/user/rymuelle/MonoTop/samples'
